TRUNCATE TABLE MMAPST.ST_CUSTOMER;
...
SELECT
 ...
 ,COALESCE(MGRBRANCH_ID,OPBRANCH_ID) AS OWNBRANCH_CODE
 ,NULL AS FIN_MANAGER
...
FROM
MMAPDMMKT.DMMKT_CSMAST A
WHERE TRIM(CIFTYP_ID)='I'
AND A.TX_DT=(SELECT TO_DATE(TX_DATE,'YYYYMMDD') FROM MMAPDMMKT.DMMKT_SYSTEM_DATE) --仅取"今日"数据
;
COMMIT;
