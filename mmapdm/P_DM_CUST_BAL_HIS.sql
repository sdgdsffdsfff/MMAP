...
BEGIN
	...
	THEN
		...
		DELETE FROM  DM_CUST_BAL_HIS   WHERE DM_START_DT = DM_TODAY;  -- 删除开始日期为"当日"的数据
		
		UPDATE DM_CUST_BAL_HIS SET DM_END_DT= DM_MAX_DATE  WHERE DM_END_DT=  DM_TODAY;  -- 更新结束日期为"当日"的数据为最大日期
