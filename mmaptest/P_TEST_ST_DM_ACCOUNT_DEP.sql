CREATE OR REPLACE PROCEDURE "P_TEST_ST_DM_ACCOUNT_DEP"
  AS
  
TRANS_NAME VARCHAR2(50) :='P_TEST_ST_DM_ACCOUNT_DEP' ; --存储过程名

V_TABLE_NAME VARCHAR2(50) :='DM_ACCOUNT_DEP';  -- 测试目标表名
